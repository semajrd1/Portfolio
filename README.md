...
- Leading investigatory work on **Distributed Fibre Optical Sensing (DFOS)** for composite manufacturing applications.
- Developed **machine learning models** for real-time **resin flow monitoring** in wind turbine blade production.
- Designed a cross-platform **3D CAD visualization tool** to analyze strain and temperature distribution data.

### **Research Associate – Composite Design and Manufacture**
**University of Sheffield (_Sept 2023 - Present_)**
- Led **structural design** and **manufacturing trials** for a **2.0m CFRP tidal turbine blade** in collaboration with the University of Oxford.
- Conducted **finite element simulations (ABAQUS)** to validate composite resilience under marine conditions.

### **Research Associate – Pilot-Scale RTM Machine Design**
**The University of Edinburgh (_Sept 2022 - Sept 2023_)**
- Designed and optimized a **pilot-scale Resin Transfer Molding (RTM) machine** for high-performance composites.
- Integrated **mechanical, electronic, and software components** for real-time control of polymer infusion processes.
