...
The Quick DFOS Strain Analyser is a Python-based GUI application designed to process, analyze, and visualize Distributed Fibre Optic Sensing (DFOS) strain data. The system efficiently handles large datasets using chunk-based data processing, integrates geometric transformations, and provides an interactive visualization interface.
